...
1. Download the latest Apache Atlas connector from: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-apache-atlas-package/1.8-SNAPSHOT/egeria-connector-apache-atlas-package-1.8-SNAPSHOT-jar-with-dependencies.jar
...
- Snapshot: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-apache-atlas-package/1.8-SNAPSHOT/egeria-connector-apache-atlas-package-1.8-SNAPSHOT-jar-with-dependencies.jar
